...
Если тест за час не вылетел в синий экран, то можно вернуться к 5 пункту и повышать множитель дальше. Если же тест вылетел синим экраном, то нужно повысить напряжение. Лучше повышать шагами по 50. Тоесть 1250,1300,1350 и тд. 
</details>
